...
```shell
mvn install:install-file -Dfile=payby-openapi-1.0.25.jar -DpomFile=payby-openapi-1.0.25.pom
mvn install:install-file -Dfile=payby-sdk-1.3.29.jar -DpomFile=payby-sdk-1.3.29.pom
```
...
```shell
mvn deploy:deploy-file -Durl=company maven repository url path -DrepositoryId=repository name -Dfile=payby-openapi-1.0.25.jar -DpomFile=payby-openapi-1.0.25.pom
mvn deploy:deploy-file -Durl=company maven repository url path -DrepositoryId=repository name -Dfile=payby-sdk-1.3.29.jar -DpomFile=payby-sdk-1.3.29.pom
```
...
```shell
com.payby.gateway:payby-sdk:jar:1.3.29
 +- com.payby.gateway:payby-openapi:jar:1.0.25:compile
