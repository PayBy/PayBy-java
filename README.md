...
```shell
mvn install:install-file -Dfile=payby-openapi-1.0.21.jar -DpomFile=payby-openapi-1.0.21.pom
mvn install:install-file -Dfile=payby-sdk-1.3.25.jar -DpomFile=payby-sdk-1.3.25.pom
```
...
```shell
mvn deploy:deploy-file -Durl=company maven repository url path -DrepositoryId=repository name -Dfile=payby-openapi-1.0.21.jar -DpomFile=payby-openapi-1.0.21.pom
mvn deploy:deploy-file -Durl=company maven repository url path -DrepositoryId=repository name -Dfile=payby-sdk-1.3.25.jar -DpomFile=payby-sdk-1.3.25.pom
```
...
```shell
com.payby.gateway:payby-sdk:jar:1.3.25
 +- com.payby.gateway:payby-openapi:jar:1.0.21:compile
